      ...
      <main className="flex flex-1 flex-col items-center px-6 pt-12 pb-20 md:px-12 md:pt-20">
        <div className="w-full max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base text-muted-foreground sm:text-lg leading-relaxed">
            ...
            <span className="font-semibold text-foreground"> builders</span>, not just coders.
          </p>
          <div className="mt-10">
            {submitted ? (
        ...
        <div className="mt-16 grid w-full max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3">
          <RoleCard icon={<Code2 className="h-6 w-6" />} title="Engineering" description="Backend, frontend, mobile, and infrastructure teams." />
          <RoleCard icon={<Lightbulb className="h-6 w-6" />} title="Product" description="Product management, design, and user research." />
          <RoleCard icon={<Settings className="h-6 w-6" />} title="Operations" description="Customer success, compliance, and business ops." />
        </div>
      </main>
    </div>
  );
